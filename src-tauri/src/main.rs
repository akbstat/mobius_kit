...
fn main() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            atem::rawdata::list_project_version,
            atem::rawdata::list_forms,
            atem::rawdata::list_items,
            atem::rawdata::get_form_by_id,
            atem::rawdata::create_project_version,
            atem::rawdata::modify_project_version,
            atem::rawdata::get_item_by_id,
            atem::rawdata::get_option_by_id,
            atem::rawdata::get_unit_by_id,
            atem::rawdata::search_in_form,
            atem::annotation::list_annotation_by_form,
            ...
            atem::annotation::create_annotation,
            atem::annotation::update_annotation,
            atem::annotation::remove_annotation,
            atem::annotation::search_in_annotation,
            atem::annotation::generate_annotations,
            atem::annotation::migrate_annotations,
            atem::metadata::list_languages,
            atem::metadata::list_sdtm_version,
            atem::metadata::list_sdtm_domains,
            atem::metadata::list_sdtm_variables,
        ])
